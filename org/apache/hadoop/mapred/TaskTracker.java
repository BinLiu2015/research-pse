...
public class TaskTracker implements MRConstants, TaskUmbilicalProtocol,
  ...
  public synchronized TrackerChildResponse statusUpdate(TaskAttemptID taskid,
    ...
    if (tip != null) {
      ...
      return new TrackerChildResponse(true,
          needCheckpointTasks.contains(taskid));
    } else {
  ...
  public synchronized TrackerChildResponse/* boolean */ping(TaskAttemptID taskid)
      throws IOException {
    // return tasks.get(taskid) != null;
    return new TrackerChildResponse(tasks.get(taskid) != null,
        needCheckpointTasks.contains(taskid));
  }
